      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className={`grid grid-cols-1 md:grid-cols-4 gap-10 pb-12 border-b text-xs ${
          ...
          <div className="space-y-4">
            ...
            <p className={`leading-relaxed ${isDark ? 'text-neutral-400' : 'text-slate-700 font-medium'}`}>
              Biểu tượng xe tay ga cỡ lớn sang trọng hàng đầu Việt Nam, mang đẳng cấp quý tộc Ý và sức mạnh công nghệ đột phá.
            </p>
            <div className={`flex items-center gap-2 ${isDark ? 'text-neutral-400' : 'text-slate-800 font-semibold'}`}>
          ...
          <div>
            ...
            <ul className={`space-y-2 ${isDark ? 'text-neutral-400' : 'text-slate-700 font-medium'}`}>
