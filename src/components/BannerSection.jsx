...
export default function BannerSection({ onOpenTestRide }) {
  ...
  return (
    ...
    >
      ...
      {/*    (Luxury Obsidian Night Showroom inside aperture)          */}
      {/* ============================================================ */}
      <div 
        ref={portalLayerRef}
        ...
        style={{
          ...
          background: 'radial-gradient(circle at 50% 50%, #151b28 0%, #0c1017 45%, #07090e 85%)',
        }}
      >
        {/* Studio Lighting inside the portal */}
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[800px] h-[500px] rounded-full blur-[140px] bg-slate-700/25" />
          <div className="absolute inset-0 bg-tech-grid opacity-15" />
        </div>
